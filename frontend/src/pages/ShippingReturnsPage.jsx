            ...
            <div className="container mx-auto px-6 max-w-3xl">
                ...
                <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 1, delay: 0.2 }} className="space-y-16 text-secondary/80 text-sm leading-relaxed">
                    ...
                    <section>
                        ...
                        <div className="space-y-4">
                            <p>We maintain a rigorous standard of quality. If your purchase does not meet your expectations, we accept returns and exchanges within 3 days of delivery.</p>
